package com.titusnangi.theweather.utils;
...
public class Constants {
    ...
    public static class apiKeys {
        public final static String WEATHER_API = "3714269f3192f8badb5b588c3e5a14af";
    }

    public static class defaultLatLng {
        public final static double DEFAULT_LAT = 28.2184;
        public final static double DEFAULT_LNG = -25.7313;
