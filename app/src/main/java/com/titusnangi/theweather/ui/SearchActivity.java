...
import com.titusnangi.theweather.adapter.SearchForecastRVAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    private void getWeatherByCityNUnit(final String searchString, final String temp_unit) {
        ...
        weather_url = String.format("weather?q=%s&units=%s&appid=%s", searchString, temp_unit, Constants.apiKeys.WEATHER_API);
                    ...
                    public void onResponse(Call<CurrentWeatherResponse> call, Response<CurrentWeatherResponse> response) {
                        if (response.isSuccessful()){
                            ...
                            if (cityName.toLowerCase().contains(searchString)){
                                ...
                                if (cityName.contains("Pretoria")){
                                    String city_country = cityName + ", PTA";
        ...
        forecast_weather_url = String.format("forecast?q=%s&units=%s&appid=%s", searchString, temp_unit, Constants.apiKeys.WEATHER_API);
